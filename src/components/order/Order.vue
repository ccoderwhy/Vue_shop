    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" icon="el-icon-edit" @click="showEditDialog(scope.row.order_id)"></el-button>
            <el-button
              type="success"
              size="mini"
...
export default {
  ...
  methods: {
    async getOrderList () {
      ...
      console.log(this.queryInfo.query,'queryInfo.query')
    ...
    // 编辑信息
   async showEditDialog (order_id) {
      const { data: res } = await this.$http.get('orders/' + order_id)
